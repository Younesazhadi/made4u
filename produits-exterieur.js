// ============================================
// PRODUCTS PAGE - EXTERIEUR - JavaScript
// VERSION OPTIMISÉE - Chargement rapide
// ============================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Afficher toutes les cartes dès le chargement (100ms après)
    setTimeout(() => {
        productCards.forEach(card => {
            card.classList.add('visible');
        });
        console.log('✅ Cartes chargées immédiatement');
    }, 100);
    ...
    console.log('✅ Page chargée - Mode:', window.innerWidth <= 968 ? 'MOBILE' : 'DESKTOP');
